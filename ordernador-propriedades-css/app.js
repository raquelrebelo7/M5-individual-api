...
console.log("Bem vindo, este é o ordenador de propriedades CSS, você pode inserir quantas vocês quiser abaixo e digitar SAIR para exibir a lista de propriedade passadas de forma ordenada.")
